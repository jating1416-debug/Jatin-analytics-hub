    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-widget about-widget" style={{ textAlign: 'center' }}>
        ...
        <div className="social-links" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          ...
          <a className="social-link social-kaggle" href="https://kaggle.com/jatinkhandelwal112" target="_blank" rel="noopener" style={{ background: '#0092d0', color: '#fff', padding: '8px', borderRadius: 8, textDecoration: 'none', fontSize: '0.8rem', fontWeight: 600, textAlign: 'center' }}><i className="fab fa-kaggle" /> Kaggle</a>
